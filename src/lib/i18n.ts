...
export const translations = {
  id: {
    ...
    // Ideation Redesign
    label_main_topic: 'TOPIK BISNIS UTAMA',
    placeholder_main_topic: 'mis. Platform digital untuk UMKM di Indonesia...',
    label_industry_category: 'KATEGORI INDUSTRI',
    label_target_market: 'TARGET PASAR',
    placeholder_target_market: 'mis. UMKM berusia 25-45 tahun di Jabodetabek',
    btn_start_analysis: 'Mulai Analisis',
    status_ai_analyzing: 'AI sedang menganalisis topik Anda...',
    toast_ai_success: '✓ AI telah mengisi draft awal. Silakan review dan sesuaikan.',
    tab_references: 'Referensi & Kompetitor',
    label_references: 'REFERENSI',
    label_competitors: 'KOMPETITOR',
    label_swot: 'SWOT QUICK VIEW',
    label_weakness: 'KELEMAHAN',
    label_opportunity: 'PELUANG',
    label_swot_s: 'S (Kekuatan)',
    label_swot_w: 'W (Kelemahan)',
    label_swot_o: 'O (Peluang)',
    label_swot_t: 'T (Ancaman)',
    btn_add_reference: 'Tambah Referensi',
    btn_add_competitor: 'Tambah Kompetitor',
    btn_gen_swot: 'Buat Analisis SWOT Lengkap',
    completion_status: 'seksi selesai',
    status_not_saved: 'Belum tersimpan',
  ...
  en: {
    ...
    // Ideation Redesign
    label_main_topic: 'MAIN BUSINESS TOPIC',
    placeholder_main_topic: 'e.g. Digital platform for SMEs in Indonesia...',
    label_industry_category: 'INDUSTRY CATEGORY',
    label_target_market: 'TARGET MARKET',
    placeholder_target_market: 'e.g. SMEs aged 25-45 in Jabodetabek',
    btn_start_analysis: 'Start Analysis',
    status_ai_analyzing: 'AI is analyzing your topic...',
    toast_ai_success: '✓ AI has filled the initial draft. Please review and adjust.',
    tab_references: 'References & Competitors',
    label_references: 'REFERENCES',
    label_competitors: 'COMPETITORS',
    label_swot: 'SWOT QUICK VIEW',
    label_weakness: 'WEAKNESS',
    label_opportunity: 'OPPORTUNITY',
    label_swot_s: 'S (Strengths)',
    label_swot_w: 'W (Weaknesses)',
    label_swot_o: 'O (Opportunities)',
    label_swot_t: 'T (Threats)',
    btn_add_reference: 'Add Reference',
    btn_add_competitor: 'Add Competitor',
    btn_gen_swot: 'Generate Complete SWOT Analysis',
    completion_status: 'sections completed',
